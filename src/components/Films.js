export const Films = [
    {
        ...
        year: 1999,
        nation: 'USA',
        description : 'The reign of House Targaryen begins: House of the Dragon, the prequel to Game of Thrones, is here. Based on George R.R. Martin’s “Fire & Blood,” the series, which is set 200 years before the events of Game of Thrones, tells the story of House Targaryen.House of the Dragon stars Paddy Considine (HBO’s The Third Day and The Outsider), Matt Smith (Doctor Who), Olivia Cooke, Emma D’Arcy, Steve Toussaint (It’s a Sin, Doctor Who), Eve Best, Sonoya Mizuno, Fabien Frankel, and Rhys Ifans. Additional cast members include Milly Alcock, Bethany Antonia, Phoebe Campbell, Emily Carey, Harry Collett, Ryan Corr, Tom Glynn-Carney, Jefferson Hall, David Horovitch, Wil Johnson, John Macmillan, Graham McTavish, Ewan Mitchell, Theo Nate, Matthew Needham, Bill Paterson, Phia Saban, Gavin Spokes, and Savannah Steyn. See the cast and characters '    
    },
    {
        id: 2,
        img : require('../assets/images/escape.jpg'),  
        title: 'Escape',
        year: 1999,
        nation: 'USA',     
        description: 'The film was shot on location in Kent, London and Paris. Savage wrote a general treatment of the story, but all the dialogue was improvised. Scenes were filmed in and around the Gravesend area in Kent, including Northfleet Nursery which was used as Tara’s son’s day centre. Imperial Business Park also features, as Tara’s local place for shopping. Production also filmed in and around Dartford, as well as at a nearby kids’ playground in Swanscombe. And a scene was also filmed at Ebbsfleet International Station, where Tara (Gemma Arterton) watches the trains on one occasion and later leaves for Paris'
    },
    {
        id: 3,
        img : require('../assets/images/lord_of_rings.jpg'),  
        title: 'Lord Of Rings',
        year: 1999,
        nation: 'USA',
        description: 'The Lord of the Rings is a series of three epic fantasy adventure films directed by Peter Jackson, based on the novel written by J. R. R. Tolkien. The films are subtitled The Fellowship of the Ring (2001), The Two Towers (2002), and The Return of the King (2003). Produced and distributed by New Line Cinema with the co-production of WingNut Films, the series is an international venture between New Zealand and the United States. The films feature an ensemble cast including Elijah Wood, Ian McKellen, Liv Tyler, Viggo Mortensen, Sean Astin, Cate Blanchett, John Rhys-Davies, Christopher Lee, Billy Boyd, Dominic Monaghan, Orlando Bloom, Hugo Weaving, Andy Serkis and Sean Bean.'     
    },
    {
        id: 4,
    ...
    {
        id: 8,
        img : require('../assets/images/us.jpg'),  
        title: 'US',
        year: 1989,
        nation: 'USA',
        description: 'Star Wars (retroactively titled Star Wars: Episode IV – A New Hope) is a 1977 American epic space opera film written and directed by George Lucas, produced by Lucasfilm and distributed by 20th Century Fox. It is the first film in the Star Wars film series and fourth chronological chapter of the "Skywalker Saga". Set "a long time ago" in a fictional universe where the galaxy is ruled by the tyrannical Galactic Empire, the story focuses on a group of freedom fighters known as the Rebel Alliance, who aim to destroy the Empire newest weapon, the Death Star. Luke Skywalker becomes caught in the conflict while learning the ways of a metaphysical power known as "the Force" from Jedi Master Obi-Wan Kenobi. The cast includes Mark Hamill, Harrison Ford, Carrie Fisher, Peter Cushing, Alec Guinness, David Prowse, James Earl Jones, Anthony Daniels, Kenny Baker, and Peter Mayhew.'     
    ...
    {
        id: 9,
        img : require('../assets/images/peaky_blinders.jpg'),  
